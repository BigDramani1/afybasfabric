                        ...
                        <form action="../actions/update_brand.php" method = "post">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="update_brand"  value="<?php echo $brand['brand_name'] ?>" placeholder="Brand Name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-actions form-group" style="position:relative; left:45%"><button type="submit" name="update" class="btn btn-success btn-sm">Submit</button></div>
                            </form>
                        </div>
                    </div>
                </div>
