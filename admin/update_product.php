                    ...
                    <div class="header-left">
                        ...
                        <div class="user-area dropdown float-right">
                            <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                                <img class="user-avatar rounded-circle" src="images/dra.jpg" alt="User Avatar">
                            </a>
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide"  enctype="multipart/form-data" action="../actions/update_product.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="product_keywords">Product number of yards<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control"  name="product_yards" placeholder="Product Yards" value="<?php echo $product['product_yards'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
