...
<head>
    ...
    <meta name="description" content="Ela Admin - HsrcTML5 Admin Template">
...
<aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-6" style="margin-top:100px; position:relative; margin-right:auto; margin-left:auto;">
                    <div class="card">
                        <div class="card-header">Adding Brand </div>
                  ...
                  <?php
                                ...
                                <div class="form-actions form-group" style="position:relative; left:45%"><button type="submit" name="add" class="btn btn-success btn-sm">Submit</button></div>
                            </form>
                        </div>
                    </div>
                </div>
