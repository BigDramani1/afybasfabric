...
$cat = select_one_category_controller($_GET['cat_id']);
?>
<!doctype html>
...
<aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="clearfix"></div>
        <div class="col-lg-6" style="margin-top:100px; position:relative; margin-right:auto; margin-left:auto;">
                    <div class="card">
                        <div class="card-header">Updating Brand </div>
                        ...
                        <form action="../actions/update_category.php" method = "post">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text"  name="cat_name"  value="<?php echo $cat['cat_name'] ?>" placeholder="Category Name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-actions form-group" style="position:relative; left:45%"><button type="submit" name="update_cat" class="btn btn-success btn-sm">Submit</button></div>
                            </form>
                        </div>
                    </div>
                </div>
