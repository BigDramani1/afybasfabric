                                    ...
                                    <?php
                                        ...
                                        foreach($brands as $brand){
                                         echo "
                                            ...
                                            <td><a href='../admin/update_brand.php?brand_id={$brand['brand_id']}' class='btn btn-primary'>Update</a></td>
                                            <td><a href='../actions/delete_brand.php?brand_id={$brand['brand_id']}' class='btn btn-danger'>Delete</a></td>
                                            </tr>
                                            ";
                                            }
                                            ?>
