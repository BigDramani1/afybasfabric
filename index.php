    ...
    <section class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 p-5 mt-3">
                ...
                <h2 class="h5 text-center mt-3 mb-3">Materials</h2>
                <p class="text-center"><a  href="view/shop.php" class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
        ...
        <div class="container py-5">
            ...
            <div class="row">
                            ...
                            <div class="card rounded-0">
                                ...
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white mt-2" href="view/shop_detail.php"><i class="far fa-eye"></i></a></li>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="./assets/img/2.jpg">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
                                        <li><a class="btn btn-success text-white mt-2" href="view/shop_detail.php"><i class="far fa-eye"></i></a></li>
                                        <li><a class="btn btn-success text-white mt-2" href="view/shop_detail.php"><i class="fas fa-cart-plus"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        <div class="card-body">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="./assets/img/3.jpg">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    <ul class="list-unstyled">
