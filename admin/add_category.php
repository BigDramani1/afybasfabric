...
<aside id="left-panel" class="left-panel">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="clearfix"></div>
        <div class="col-lg-6" style="position:relative; margin-right:auto; margin-left:auto;">
                    <div class="card">
                  ...
                  <?php
                                ...
                                <div class="form-actions form-group" style="position:relative; left:45%"><button type="submit" name="add_cat" class="btn btn-success btn-sm">Submit</button></div>
                            </form>
                        </div>
                    </div>
                </div>
