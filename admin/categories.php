                                    ...
                                    <?php
                                        ...
                                        foreach($categories as $category){
                                         echo "
                                            ...
                                            <td><a href='../admin/update_category.php?cat_id={$category['cat_id']}' class='btn btn-primary'>Update</a></td>
                                            <td><a href='../actions/delete_category.php?cat_id={$category['cat_id']}' class='btn btn-danger'>Delete</a></td>
                                            </tr>
                                            ";
                                            }
                                            ?>
